...
$freeradiusclients = [
    'varclientip' => $config["interfaces"]["{H_LAN_INTERFACES}"]["ipaddr"],
    'varclientipversion' => "ipaddr",
    'varclientshortname' => "HOTSPOT",
    'varclientsharedsecret' => "hotspot",
    'varclientproto' => "udp",
...
$freeradiussqlconf = [
    ...
    "varsqlconfport" => 3306,
    "varsqlconflogin" => "{H_MYSQL_USER_NAME}",
    "varsqlconfpassword" => "{H_MYSQL_USER_PASS}",
    "varsqlconfradiusdb" => "{H_MYSQL_DBNAME}",
...
$captiveportal = [
    ...
    "zoneid" => 1,
    "interface" => "{H_KABLOSUZ_INTERFACES}",
    "maxproc" => null,
    "timeout" => null,
    "idletimeout" => null,
...
$config["captiveportal"]["hotspot"] = $captiveportal;
...
sql sql1 {
	...
	server = "localhost"
	port = 3306
	login = "{H_MYSQL_USER_NAME}"
	password = "{H_MYSQL_USER_PASS}"
	radius_db = "{H_MYSQL_DBNAME}"
	acct_table1 = "radacct"
	acct_table2 = "radacct"
...
$lanip = $config["interfaces"]["{H_LAN_INTERFACES}"]["ipaddr"];
$clientsconf = <<<EOF
...
$config['system']['authserver'][] = array(
	...
	'radius_secret' => 'hotspot',
	'radius_timeout' => '5',
	'radius_auth_port' => '1812',
	'radius_acct_port' => '1813',
);

write_config("Hotspot Settings added.");